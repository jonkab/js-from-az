...
console.log("----- Exercice A : Filtrez les entreprises revenue > 500 milliards -----");
/* 
    A. Vers l'infini et l'au-delà.

    Filtrez les entreprises dont la revenue annuelle est supérieur à 500 milliards de dollars dans un nouveau
    tableau appelé "filteredCompanies" et retournez-le dans la console.
*/
...
console.log("\n\n----- Exercice B : Ménage de printemps -----");
/* 
...
const filteredNames = names.filter(name => name[0] === "A" && name.length >= 5 );
