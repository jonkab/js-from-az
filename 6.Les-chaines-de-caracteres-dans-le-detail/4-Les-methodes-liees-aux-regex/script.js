/* 
    Après avoir vu les différentes caractéristiques des expressions régulières,
    découvrons ensemble les méthodes qui les utilisent.
*/
...
/* 
   ...
   Le remplacement peut être global ou unique, suivant le /g au niveau du regex.
*/

    console.log("Bo1nj1ou11r l1e m111onde".replace("1",""))
    // Bonj1ou11r l1e m111onde

    console.log("Bo1nj1ou11r l1e m111onde".replace(/1/,""))
    // Bonjour le monde

    console.log("Bo1nj1ou11r l1e m111onde".replace(/1/g,""))
    // Bonj1ou11r l1e m111onde

    console.log("J'adore les chiens".replace("chiens","chats"))
    // "J'adore les chats"
